...
class MainController < ApplicationController
  ...
  def set_release(release)
    if release == "111"
       ...
       @isos["lang-32"] = "Addon-Lang-Build1034-i586"
       @isos["lang-64"] = "Addon-Lang-Build1034-x86_64"
       @isos["nonoss"] = "Addon-NonOss-BiArch-Build1034-i586-x86_64"
       @isos["kde-64"] = "KDE-LiveCD-Build1034-x86_64"
       @isos["kde-32"] = "KDE-LiveCD-Build1034-i686"
       @isos["gnome-64"] = "GNOME-LiveCD-Build1034-x86_64"
       @isos["gnome-32"] = "GNOME-LiveCD-Build1034-i686"
       @isos["dvd-64"] = "DVD-Build1034-x86_64"
       @isos["dvd-32"] = "DVD-Build1034-i586"
       @isos["net-32"] = "NET-Build1034-i586"
       @isos["net-64"] = "NET-Build1034-x86_64"
