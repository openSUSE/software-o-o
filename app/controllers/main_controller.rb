...
class MainController < ApplicationController
  ...
  def set_release(release)
    if release == "113"
      ...
      @isos = {}
      @directory = "http://download.opensuse.org/distribution/12.2-Milestone2"
      @isos["lang-32"] = "Addon-Lang-Build0258-i586"
      @isos["lang-64"] = "Addon-Lang-Build0258-x86_64"
      @isos["nonoss"] = "Addon-NonOss-BiArch-Build0258-i586-x86_64"
      @isos["kde-64"] = "KDE-LiveCD-Build0258-x86_64"
      @isos["kde-32"] = "KDE-LiveCD-Build0258-i686"
      @isos["gnome-64"] = "GNOME-LiveCD-Build0258-x86_64"
      @isos["gnome-32"] = "GNOME-LiveCD-Build0258-i686"
      @isos["dvd-64"] = "DVD-Build0258-x86_64"
      @isos["dvd-32"] = "DVD-Build0258-i586"
