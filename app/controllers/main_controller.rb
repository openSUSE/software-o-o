...
class MainController < ApplicationController
  ...
  def set_release(release)
    if release == "111"
       ...
       @isos = {}
       @directory = "http://download.opensuse.org/distribution/11.4-Milestone2"
       @isos["lang-32"] = "Addon-Lang-i586-Build0754-Media"
       @isos["lang-64"] = "Addon-Lang-x86_64-Build0754-Media"
       @isos["nonoss"] = "Addon-NonOss-BiArch-i586-Build0754-Media-x86_64"
       @isos["kde-64"] = "KDE-LiveCD-x86_64-Build0754-Media"
       @isos["kde-32"] = "KDE-LiveCD-i686-Build0754-Media"
       @isos["gnome-64"] = "GNOME-LiveCD-x86_64-Build0754-Media"
       @isos["gnome-32"] = "GNOME-LiveCD-i686-Build0754-Media"
       @isos["dvd-64"] = "DVD-x86_64-Build0754-Media"
       @isos["dvd-32"] = "DVD-i586-Build0754-Media"
       @isos["net-32"] = "NET-i586-Build0754-Media"
       @isos["net-64"] = "NET-x86_64-Build0754-Media"

       @releasenotes = "http://www.suse.de/relnotes/i386/openSUSE/11.4/RELEASE-NOTES.en.html"
       @releasename = "openSUSE 11.4 Milestone 2 of 6"
