...
class MainController < ApplicationController
  ...
  def set_release(release)
    if release == "121"
      ...
      @isos = {}
      @directory = "http://download.opensuse.org/distribution/13.1-RC1"
      @isos["lang-32"] = "13.1-Addon-Lang-Build0041-i586"
      @isos["lang-64"] = "13.1-Addon-Lang-Build0041-x86_64"
      @isos["nonoss"] = "13.1-Addon-NonOss-BiArch-Build0041-i586-x86_64"
      @isos["kde-64"] = "13.1-KDE-Live-Build0041-x86_64"
      @isos["kde-32"] = "13.1-KDE-Live-Build0041-i686"
      @isos["gnome-64"] = "13.1-GNOME-Live-Build0041-x86_64"
      @isos["gnome-32"] = "13.1-GNOME-Live-Build0041-i686"
      @isos["dvd-64"] = "13.1-DVD-Build0041-x86_64"
      @isos["dvd-32"] = "13.1-DVD-Build0041-i586"
      @isos["rescue-32"] = "13.1-Rescue-CD-Build0041-i686"
      @isos["rescue-64"] = "13.1-Rescue-CD-Build0041-x86_64"
