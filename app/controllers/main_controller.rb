...
class MainController < ApplicationController
  ...
  def set_release(release)
    if release == "111"
      ...
      @isos = {}
      @directory = "http://download.opensuse.org/distribution/12.1-Milestone5"
      @isos["lang-32"] = "Addon-Lang-Build0250-i586"
      @isos["lang-64"] = "Addon-Lang-Build0250-x86_64"
      @isos["nonoss"] = "Addon-NonOss-BiArch-Build0250-i586-x86_64"
      @isos["kde-64"] = "KDE-LiveCD-Build0250-x86_64"
      ...
      @releasename = "openSUSE 12.1 Milestone 5"
