...
class MainController < ApplicationController
  ...
  def set_release(release)
    if release == "111"
       ...
       @isos = {}
       @directory = "http://download.opensuse.org/distribution/11.4-Milestone4"
       @isos["lang-32"] = "Addon-Lang-Build0908-i586"
       @isos["lang-64"] = "Addon-Lang-Build0908-x86_64"
       @isos["nonoss"] = "Addon-NonOss-BiArch-Build0908-i586-x86_64"
       @isos["kde-64"] = "KDE-LiveCD-Build0908-x86_64"
       @isos["kde-32"] = "KDE-LiveCD-Build0908-i686"
       @isos["gnome-64"] = "GNOME-LiveCD-Build0908-x86_64"
       @isos["gnome-32"] = "GNOME-LiveCD-Build0908-i686"
       @isos["dvd-64"] = "DVD-Build0908-x86_64"
       @isos["dvd-32"] = "DVD-Build0908-i586"
       @isos["net-32"] = "NET-Build0908-i586"
       @isos["net-64"] = "NET-Build0908-x86_64"

       @releasenotes = "http://www.suse.de/relnotes/i386/openSUSE/11.4/RELEASE-NOTES.en.html"
       @releasename = "openSUSE 11.4 Milestone 4 of 6"
