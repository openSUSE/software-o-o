...
class MainController < ApplicationController
  ...
  def set_release(release)
    if release == "111"
      ...
      @isos = {}
      @directory = "http://download.opensuse.org/distribution/12.1-RC1"
      @isos["lang-32"] = "Addon-Lang-Build0379-i586"
      @isos["lang-64"] = "Addon-Lang-Build0379-x86_64"
      @isos["nonoss"] = "Addon-NonOss-BiArch-Build0379-i586-x86_64"
      @isos["kde-64"] = "KDE-LiveCD-Build0379-x86_64"
      @isos["kde-32"] = "KDE-LiveCD-Build0379-i686"
      @isos["gnome-64"] = "GNOME-LiveCD-Build0379-x86_64"
      @isos["gnome-32"] = "GNOME-LiveCD-Build0379-i686"
      @isos["dvd-64"] = "DVD-Build0379-x86_64"
      @isos["dvd-32"] = "DVD-Build0379-i586"
      @isos["net-32"] = "NET-Build0379-i586"
      @isos["net-64"] = "NET-Build0379-x86_64"

      @releasenotes = "http://www.suse.de/relnotes/i386/openSUSE/12.1/RELEASE-NOTES.en.html"
      @releasename = "openSUSE 12.1 RC 1"
