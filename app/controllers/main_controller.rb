...
class MainController < ApplicationController
  ...
  def set_release(release)
    if release == "121"
      ...
      @isos = {}
      @directory = "http://download.opensuse.org/distribution/12.3-RC1"
      @isos["lang-32"] = "12.3-Addon-Lang-Build0024-i586"
      @isos["lang-64"] = "12.3-Addon-Lang-Build0024-x86_64"
      @isos["nonoss"] = "12.3-Addon-NonOss-BiArch-Build0024-i586-x86_64"
      @isos["kde-64"] = "12.3-KDE-LiveCD-Build0024-x86_64"
      @isos["kde-32"] = "12.3-KDE-LiveCD-Build0024-i686"
      @isos["gnome-64"] = "12.3-GNOME-LiveCD-Build0024-x86_64"
      ...
      @releasename = "openSUSE 12.3 RC 1"
