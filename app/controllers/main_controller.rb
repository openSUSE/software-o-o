...
class MainController < ApplicationController
  ...
  def set_release(release)
    if release == "111"
       ...
       @isos = {}
       @directory = "http://download.opensuse.org/distribution/11.4-RC1"
       @isos["lang-32"] = "Addon-Lang-Build1057-i586"
       @isos["lang-64"] = "Addon-Lang-Build1057-x86_64"
       @isos["nonoss"] = "Addon-NonOss-BiArch-Build1056-i586-x86_64"
       @isos["kde-64"] = "KDE-LiveCD-Build1056-x86_64"
       @isos["kde-32"] = "KDE-LiveCD-Build1056-i686"
       @isos["gnome-64"] = "GNOME-LiveCD-Build1056-x86_64"
       @isos["gnome-32"] = "GNOME-LiveCD-Build1056-i686"
       @isos["dvd-64"] = "DVD-Build1056-x86_64"
       @isos["dvd-32"] = "DVD-Build1056-i586"
       @isos["net-32"] = "NET-Build1056-i586"
       @isos["net-64"] = "NET-Build1056-x86_64"

       @releasenotes = "http://www.suse.de/relnotes/i386/openSUSE/11.4/RELEASE-NOTES.en.html"
       @releasename = "openSUSE 11.4 RC 1"
