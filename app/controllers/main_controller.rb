...
class MainController < ApplicationController
  ...
  def set_release(release)
    if release == "121"
      ...
      @isos = {}
      @directory = "http://download.opensuse.org/distribution/12.3-Beta1"
      @isos["lang-32"] = "Addon-Lang-Build0348-i586"
      @isos["lang-64"] = "Addon-Lang-Build0348-x86_64"
      @isos["nonoss"] = "Addon-NonOss-BiArch-Build0348-i586-x86_64"
      @isos["kde-64"] = "KDE-LiveCD-Build0348-x86_64"
      @isos["kde-32"] = "KDE-LiveCD-Build0348-i686"
      @isos["gnome-64"] = "GNOME-LiveCD-Build0348-x86_64"
      @isos["gnome-32"] = "GNOME-LiveCD-Build0348-i686"
      @isos["dvd-64"] = "DVD-Build0348-x86_64"
      @isos["dvd-32"] = "DVD-Build0348-i586"
      @isos["net-32"] = "NET-Build0348-i586"
      @isos["net-64"] = "NET-Build0348-x86_64"

      @releasenotes = _("https://www.suse.com/releasenotes/x86_64/openSUSE/12.3")
      @releasename = "openSUSE 12.3 Beta 1"
