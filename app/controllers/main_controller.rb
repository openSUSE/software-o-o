...
class MainController < ApplicationController
  ...
  def set_release(release)
    if release == "121"
      ...
      @isos = {}
      @directory = "http://download.opensuse.org/distribution/13.1-Milestone4"
      @isos["lang-32"] = "Factory-Addon-Lang-Build0651-i586"
      @isos["lang-64"] = "Factory-Addon-Lang-Build0651-x86_64"
      @isos["nonoss"] = "Factory-Addon-NonOss-BiArch-Build0652-i586-x86_64"
      @isos["kde-64"] = "Factory-KDE-Live-Build0652-x86_64"
      @isos["kde-32"] = "Factory-KDE-Live-Build0651-i686"
      @isos["gnome-64"] = "Factory-GNOME-Live-Build0652-x86_64"
      @isos["gnome-32"] = "Factory-GNOME-Live-Build0652-i686"
      @isos["dvd-64"] = "Factory-DVD-Build0651-x86_64"
      @isos["dvd-32"] = "Factory-DVD-Build0653-i586"
      @isos["rescue-32"] = "Factory-Rescue-CD-Build0000-i686"
      @isos["rescue-64"] = "Factory-Rescue-CD-Build0000-x86_64"
      @isos["net-32"] = "Factory-NET-Build0652-i586"
      @isos["net-64"] = "Factory-NET-Build0652-x86_64"

      @releasenotes = _("https://www.suse.com/releasenotes/x86_64/openSUSE/13.1")
      @releasename = "openSUSE 13.1 Milestone 4"
