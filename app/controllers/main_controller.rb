...
class MainController < ApplicationController
  ...
  def set_release(release)
    if release == "121"
      ...
      @isos = {}
      @directory = "http://download.opensuse.org/distribution/leap/42.2-Beta1"
      @leap = true
      # leap means no iso for:
      # nonoss, dvd-32, net-32, rescue-XX, kde-XX, gnome-XX, lang-XX
      @isos["dvd-64"] = "Leap-42.2-DVD-x86_64-Build0164-Media"
      @isos["net-64"] = "Leap-42.2-NET-x86_64-Build0164-Media"

      @releasenotes = _("https://doc.opensuse.org/release-notes/x86_64/openSUSE/Leap/42.2/")
      @releasename = "openSUSE 42.2 Beta 1"
