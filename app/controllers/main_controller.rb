...
class MainController < ApplicationController
  ...
  def set_release(release)
    if release == "113"
      ...
      @isos["kde-64"] = "KDE-LiveCD-x86_64-Build0091-Media"
      @isos["kde-32"] = "KDE-LiveCD-i686-Build0091-Media"
      @isos["gnome-64"] = "GNOME-LiveCD-x86_64-Build0091-Media"
      @isos["gnome-32"] = "GNOME-LiveCD-i686-Build0091-Media"
